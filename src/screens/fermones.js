...
import Fermones from "../components/Fermones";
import { TouchableOpacity } from "react-native-gesture-handler";
import Firebase from "./Firebase";

class fermones extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      image: "",
      ...
      >
        ...
        >
            ...
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate("order", {
                  Name: "FEROMONES Combo of All Purpose Plant",
                  Price: 505,
                })
              }
            >
          ...
          >
            <TouchableOpacity
              onPress={() =>
                this.Addtocart("FEROMONES Combo of All Purpose Plant", "505")
              }
            >
              <View
                style={{
